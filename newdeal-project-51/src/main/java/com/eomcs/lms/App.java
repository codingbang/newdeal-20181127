...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // AppConfig 클래스가 메모리에 로딩되어 있지 않다면, 지금 즉시 로딩 한 후 그 로딩된 클래스 정보를 리턴하라!
    // cls, clazz
    ...
    Parameter[] params = methods[0].getModifiers();
    Constructor[] constructors = clazz.getConstructors();*/


    // Spring IoC 컨테이너 준비하기
    // ApplicationContext iocContainer = new AnnotationConfigApplicationContext(clazz);
