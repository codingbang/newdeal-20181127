...
public class MariaDBLessonDao implements LessonDao {
  ...
  public int insert(Lesson lesson) throws Exception {
    ...
    try ( SqlSession sqlSession = sqlSessionFactory.openSession() ){
      int reuslt =  sqlSession.insert("LessonDao.insert", lesson);
      sqlSession.commit();
      return reuslt;
    }
  ...
  public int update(Lesson lesson) throws Exception {
    ...
    try ( SqlSession sqlSession = sqlSessionFactory.openSession() ){
      int reuslt =  sqlSession.update("LessonDao.update", lesson);
      sqlSession.commit();
      return reuslt;
    }
  }
  ...
  public int delete(int no) throws Exception {
    ...
    try ( SqlSession sqlSession = sqlSessionFactory.openSession() ){
      int reuslt =  sqlSession.delete("LessonDao.delete", no);
      sqlSession.commit();
      return reuslt;
    }
  }
